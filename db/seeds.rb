...
puts "#{ Post.count } posts created."
p15 = Post.create :images => ["https://i.imgur.com/EzwA7hO.jpg"], :content => "Why do they call it rush hour when nothing moves?"
puts "#{ Post.count } posts created."
...
puts "#{ Post.count } posts created."
p24 = Post.create :images => ["https://i.pinimg.com/originals/19/06/c5/1906c5ea141a8a3b3643f7fb8c4efc66.jpg"], :content => "Basketball hoop for sale. Son not as athletic as I hoped. Must pick up."
puts "#{ Post.count } posts created."
