...
u7 = User.create :name => "Audrey Patricia", :email => "audrey@ga.co", :password => "chicken", :profile_image => "https://www.rd.com/wp-content/uploads/2018/05/shutterstock_464300804.jpg", :cover_image => "https://www.redcliffetravel.com.au/images/_large/best_sunrises_and_sunsets_in_queensland.jpg", :bio => "Brie cheese triangles bavarian bergkase. Goat cream cheese cream cheese roquefort lancashire jarlsberg halloumi taleggio.", :birthday => "1988-02-08", :location => "Perth"
u8 = User.create :name => "Bhavya Govind", :email => "bhavya@ga.co", :password => "chicken", :profile_image => "https://i.ytimg.com/vi/JNQU-4YEnm4/sddefault.jpg", :cover_image => "https://i.pinimg.com/originals/6a/96/73/6a967367de0c43bfdf30808eb693547a.jpg", :bio => "Paneer cheese strings caerphilly the big cheese pepper jack stinking bishop fromage mozzarella. Emmental bavarian bergkase bavarian bergkase taleggio dolcelatte halloumi hard cheese emmental.", :birthday => "1987-05-08", :location => "Melbourne"
u9 = User.create :name => "David Ye", :email => "davidye@ga.co", :password => "chicken", :profile_image => "https://i.ytimg.com/vi/lfzJ3olqiug/maxresdefault.jpg", :cover_image => "https://cdn.vox-cdn.com/thumbor/Al48-pEnyIn2rlgKX7MIHNmlE68=/0x0:5563x3709/1200x800/filters:focal(2302x1311:3192x2201)/cdn.vox-cdn.com/uploads/chorus_image/image/65752607/1048232144.jpg.0.jpg", :bio => "Red leicester cheese triangles cheddar blue castello cheese and wine stilton smelly cheese when the cheese comes out everybody's happy.", :birthday => "1994-11-08", :location => "Syndey"
u10 = User.create :name => "Katie Lugton", :email => "katie@ga.co", :password => "chicken", :profile_image => "https://static8.depositphotos.com/1000387/876/i/600/depositphotos_8767134-stock-photo-amazed-or-surprised-child-boy.jpg", :cover_image => "https://ntnow.com.au/photos/1/128927_Sunset_over_Darwin_Harbour_credit_Tourism_NT_Jules_Ingall.jpg", :bio => "Brie pepper jack cheese and biscuits chalk and cheese cheese on toast chalk and cheese the big cheese camembert de normandie.", :birthday => "1992-02-22", :location => "Liverpool"
u11 = User.create :name => "Mauritz Erick", :email => "mauritz@ga.co", :password => "chicken", :profile_image => "https://i.pinimg.com/236x/bf/bc/96/bfbc96241fcdb1ea361d724a61fee990--facial-expressions-surprise.jpg", :cover_image => "https://glamadelaide.com.au/wp-content/uploads/2019/12/s-sunset-beach.jpg", :bio => "Cheese on toast melted cheese port-salut camembert de normandie blue castello cut the cheese babybel cheesy feet. ", :birthday => "1988-02-08", :location => "Manchester"
u12 = User.create :name => "Paul Calnan", :email => "paul@ga.co", :password => "chicken", :profile_image => "https://i.pinimg.com/originals/a8/06/f1/a806f18278f47647cd96108ae861abba.jpg", :cover_image => "https://particle.azureedge.net/app/uploads/2020/06/photo_2020-06-19_10-32-48-e1592547249260.jpg", :bio => "Taleggio stilton cottage cheese say cheese cheese on toast jarlsberg feta st. agur blue cheese.", :birthday => "1971-01-29", :location => "Hobart"
u13 = User.create :name => "Priyanka Patel", :email => "priyanka@ga.co", :password => "chicken", :profile_image => "https://www.askideas.com/wp-content/uploads/2016/11/Funny-Shocked-Baby-Face-Picture.jpg", :cover_image => "https://media.tacdn.com/media/attractions-splice-spp-674x446/0a/9d/29/44.jpg", :bio => "Cheddar cheese and wine mascarpone. Manchego say cheese airedale parmesan hard cheese dolcelatte chalk and cheese bavarian bergkase.", :birthday => "1980-01-08", :location => "Adelaide"
u14 = User.create :name => "Qiong Dai", :email => "nelly@ga.co", :password => "chicken", :profile_image => "https://cdn2.momjunction.com/wp-content/uploads/2015/03/100-Most-Popular-And-Funny-Baby-Names-Of-2018-Revealed.jpg", :cover_image => "https://upload.wikimedia.org/wikipedia/commons/a/a4/Anatomy_of_a_Sunset-2.jpg", :bio => "Cream cheese edam queso lancashire cheese triangles stinking bishop edam fromage frais. Cheese strings boursin taleggio pecorino port-salut boursin mozzarella.", :birthday => "1991-11-12", :location => "London"
u15 = User.create :name => "Sam Gelwyn", :email => "sam@ga.co", :password => "chicken", :profile_image => "https://i.pinimg.com/originals/b2/66/da/b266da7035ffb55760bb43157637456a.jpg", :cover_image => "https://c.tadst.com/gfx/600x337/barcelona-morning-sky.jpg?1", :bio => "Brie jarlsberg macaroni cheese paneer cheese on toast cottage cheese mozzarella cheese triangles.", :birthday => "1980-04-12", :location => "Essex"
...
puts "#{ Post.count } posts created."
p8 = Post.create :content => "I’m not superstitious, but I am a little stitious."
puts "#{ Post.count } posts created."
p9 = Post.create :content => "I walk around like everything’s fine, but deep down, inside my shoe, my sock is sliding off."
puts "#{ Post.count } posts created."
p10 = Post.create :content => "I never feel more alone than when I’m trying to put sunscreen on my back."
puts "#{ Post.count } posts created."
p11 = Post.create :content => "Common sense is like deodorant. The people who need it most never use it."
puts "#{ Post.count } posts created."
p12 = Post.create :content => "I’m at a place in my life when errands are starting to count as going out."
puts "#{ Post.count } posts created."
p13 = Post.create :content => "I’m not good at the advice. Can I interest you in a sarcastic comment?"
puts "#{ Post.count } posts created."
...
puts "#{ Post.count } posts created."
p20 = Post.create :content => "Learn a lesson from your dog. No matter what life brings you, kick some grass over that crap and move on."
puts "#{ Post.count } posts created."
p21 = Post.create :content => "I ordered a chicken and an egg from Amazon. I’ll let you know..."
puts "#{ Post.count } posts created."
p22 = Post.create :content => "Sarcasm is a body’s natural defense against stupid."
puts "#{ Post.count } posts created."
...
puts "#{ Post.count } posts created."
p26 = Post.create :content => "Laugh at your problems, everybody else does."
puts "#{ Post.count } posts created."
