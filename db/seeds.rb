...
u7 = User.create :name => "Audrey Patricia", :email => "audrey@ga.co", :password => "chicken", :profile_image => "https://www.rd.com/wp-content/uploads/2018/05/shutterstock_464300804.jpg", :cover_image => "", :bio => "Brie cheese triangles bavarian bergkase. Goat cream cheese cream cheese roquefort lancashire jarlsberg halloumi taleggio.", :birthday => "1988-02-08", :location => "Perth"
u8 = User.create :name => "Bhavya Govind", :email => "bhavya@ga.co", :password => "chicken", :profile_image => "https://i.ytimg.com/vi/JNQU-4YEnm4/sddefault.jpg", :cover_image => "", :bio => "Paneer cheese strings caerphilly the big cheese pepper jack stinking bishop fromage mozzarella. Emmental bavarian bergkase bavarian bergkase taleggio dolcelatte halloumi hard cheese emmental.", :birthday => "1987-05-08", :location => "Melbourne"
u9 = User.create :name => "David Ye", :email => "davidye@ga.co", :password => "chicken", :profile_image => "https://i.ytimg.com/vi/lfzJ3olqiug/maxresdefault.jpg", :cover_image => "", :bio => "Red leicester cheese triangles cheddar blue castello cheese and wine stilton smelly cheese when the cheese comes out everybody's happy.", :birthday => "1994-11-08", :location => "Syndey"
u10 = User.create :name => "Katie Lugton", :email => "katie@ga.co", :password => "chicken", :profile_image => "", :cover_image => "", :bio => "Brie pepper jack cheese and biscuits chalk and cheese cheese on toast chalk and cheese the big cheese camembert de normandie.", :birthday => "1992-02-22", :location => "Liverpool"
u11 = User.create :name => "Mauritz Erick", :email => "mauritz@ga.co", :password => "chicken", :profile_image => "", :cover_image => "", :bio => "Cheese on toast melted cheese port-salut camembert de normandie blue castello cut the cheese babybel cheesy feet. ", :birthday => "1988-02-08", :location => "Manchester"
u12 = User.create :name => "Paul Calnan", :email => "paul@ga.co", :password => "chicken", :profile_image => "https://i.pinimg.com/originals/a8/06/f1/a806f18278f47647cd96108ae861abba.jpg", :cover_image => "", :bio => "Taleggio stilton cottage cheese say cheese cheese on toast jarlsberg feta st. agur blue cheese.", :birthday => "1971-01-29", :location => "Hobart"
u13 = User.create :name => "Priyanka Patel", :email => "priyanka@ga.co", :password => "chicken", :profile_image => "", :cover_image => "", :bio => "Cheddar cheese and wine mascarpone. Manchego say cheese airedale parmesan hard cheese dolcelatte chalk and cheese bavarian bergkase.", :birthday => "1980-01-08", :location => "Adelaide"
u14 = User.create :name => "Qiong Dai", :email => "nelly@ga.co", :password => "chicken", :profile_image => "", :cover_image => "", :bio => "Cream cheese edam queso lancashire cheese triangles stinking bishop edam fromage frais. Cheese strings boursin taleggio pecorino port-salut boursin mozzarella.", :birthday => "1991-11-12", :location => "London"
u15 = User.create :name => "Sam Gelwyn", :email => "sam@ga.co", :password => "chicken", :profile_image => "https://i.pinimg.com/originals/b2/66/da/b266da7035ffb55760bb43157637456a.jpg", :cover_image => "", :bio => "Brie jarlsberg macaroni cheese paneer cheese on toast cottage cheese mozzarella cheese triangles.", :birthday => "1980-04-12", :location => "Essex"
